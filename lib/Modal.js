...
var Modal = React.createClass({displayName: 'Modal',
  ...
  render: function() {
    ...
    return (
      React.createElement(Fade, React.__spread({},  fadeProps, {in: props.show, animate: props.animation}), 
        React.createElement(BaseModal, React.__spread({},  props ), this.props.children)
      )
    );
  }
});
